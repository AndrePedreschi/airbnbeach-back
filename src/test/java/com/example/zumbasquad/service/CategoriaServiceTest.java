...
public class CategoriaServiceTest {
    ...
    void deveSalvarNovaCategoriaSemProduto(){
        final Categoria categoria = new Categoria(1L, "teste", "descricao", "url");
    ...
    void deveAtualizarCategoria(){
        final Categoria categoria = new Categoria(1L, "teste", "descricao", "url");
        final Categoria categoriaAtualizada = new Categoria(1L, "teste atualizado", "descricao", "url");
    ...
    void deveBuscarTodasCategorias(){
        ...
        categorias.add(new Categoria(1L, "teste1", "desc1", "url1"));
        categorias.add(new Categoria(2L, "teste2", "desc2", "url2"));
        categorias.add(new Categoria(3L, "teste3", "desc3", "url3"));
