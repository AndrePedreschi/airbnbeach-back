...
public class CaracteristicaServiceTest {
    ...
    void deveSalvarNovaCaracteristica(){
        final Caracteristica caracteristica = new Caracteristica(1L, "nome", "icone");
    ...
    void deveBuscarTodasCaracteristicas(){
        ...
        caracteristicas.add(new Caracteristica(1L, "nome", "icone"));
        caracteristicas.add(new Caracteristica(2L, "nome2", "icone2"));
