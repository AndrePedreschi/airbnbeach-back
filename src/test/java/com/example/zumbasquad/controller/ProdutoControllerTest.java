...
public class ProdutoControllerTest {
    ...
    @BeforeEach
    void setup(){
        this.cidade = new Cidade(1L, "nomeCidade", "pais");
        this.categoria = new Categoria(1L, "qualificacao", "descricao", "urlImagem");
        this.imagens = new HashSet<>();
        this.imagens.add(new Imagem(1L, "titulo", "url"));
    ...
    void deveBuscarProdutosPeloIdDaCidade() throws Exception {
        ...
        produtosTodos.add(new Produto(1L, "nome", null, true, 2f, 5f, null, null,imagens, null, new Cidade(1L, "nome", "pais"), categoria, null));
        produtosTodos.add(new Produto(2L, "nome", null, true, 2f, 5f, null, null,imagens, null, new Cidade(2L, "nome", "pais"), categoria, null));
        produtosTodos.add(new Produto(3L, "nome", null, true, 2f, 5f, null, null,imagens, null, new Cidade(1L, "nome", "pais"), categoria, null));
    ...
    void deveBuscarProdutosPeloNomeDaCidade() throws Exception {
        List<Produto> produtosTodos = new ArrayList<>();
        produtosTodos.add(new Produto(1L, "nome", null, true, 2f, 5f, null, null,imagens, null, new Cidade(1L, "nome", "pais"), categoria, null));
        produtosTodos.add(new Produto(2L, "nome", null, true, 2f, 5f, null, null,imagens, null, new Cidade(2L, "nome2", "pais"), categoria, null));
        produtosTodos.add(new Produto(3L, "nome", null, true, 2f, 5f, null, null,imagens, null, new Cidade(1L, "nome", "pais"), categoria, null));
    ...
    void deveBuscarProdutosPeloIdDaCategoria() throws Exception {
        List<Produto> produtosTodos = new ArrayList<>();
        produtosTodos.add(new Produto(1L, "nome", null, true, 2f, 5f, null, null,imagens, null, null, new Categoria(1L, "qualificacao", "descricao", "url"), null));
        produtosTodos.add(new Produto(2L, "nome", null, true, 2f, 5f, null, null,imagens, null, null, new Categoria(2L, "qualificacao", "descricao", "url"), null));
        produtosTodos.add(new Produto(3L, "nome", null, true, 2f, 5f, null, null,imagens, null, null, new Categoria(1L, "qualificacao", "descricao", "url"), null));
    ...
    void deveBuscarProdutosPeloNomeDaCategoria() throws Exception {
        List<Produto> produtosTodos = new ArrayList<>();
        produtosTodos.add(new Produto(1L, "nome", null, true, 2f, 5f, null, null,imagens, null, null, new Categoria(1L, "qualificacao", "descricao", "url"), null));
        produtosTodos.add(new Produto(2L, "nome", null, true, 2f, 5f, null, null,imagens, null, null, new Categoria(2L, "qualificacao2", "descricao", "url"), null));
        produtosTodos.add(new Produto(3L, "nome", null, true, 2f, 5f, null, null,imagens, null, null, new Categoria(1L, "qualificacao", "descricao", "url"), null));
