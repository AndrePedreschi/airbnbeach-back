...
public class CategoriaControllerTest {
    ...
    void setup(){
        ...
        this.categorias.add(new Categoria(1L, "teste1", "desc1", "url1"));
        this.categorias.add(new Categoria(2L, "teste2", "desc2", "url2"));
        this.categorias.add(new Categoria(3L, "teste3", "desc3", "url3"));
    ...
    void deveCriarNovaCategoria() throws Exception{
        ...
        Categoria categoria = new Categoria(null, "teste", "desc", "url");
...
//                .andExpect(result -> assertEquals("Não foi possível cadastrar a categoria.", result.getResolvedException().getMessage()));
    ...
    void deveExcluirCategoria() throws Exception{
        Long id = 1L;
        Categoria categoria = new Categoria(1L, "teste1", "desc1", "url1");
